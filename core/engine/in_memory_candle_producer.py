...
검사(:mod:`core.live_check`)나 비-바이낸스 소스(주식 등)처럼 캔들을 직접 넘기는 쪽이 쓴다.
바이낸스에서 구간을 fetch해 백테스트하려면 :class:`~core.engine.binance_backtest_candle_producer.BinanceBacktestCandleProducer`.
"""
