"""MassiveStockFetcher 스모크 체크 — 미국 주식 캔들이 신뢰할 만한지 확인한다.
    ...
    uv run python core/checks/fetch_stock_check.py            # AAPL, 최근 완료된 2주
    uv run python core/checks/fetch_stock_check.py MSFT       # 심볼 지정
    uv run python core/checks/fetch_stock_check.py AAPL 2025-11-24 2025-11-29   # 휴장/조기폐장 낀 주
